package com.example.softAccomany.chat;
...
import com.example.android_robot_01.ChatMessageAdapter;
...
public class Activity1 extends Activity
{
	...
	private void initView()
	{
	    ...
	    mDatas.add(new ChatMessage(Type.INPUT, "我是雷欧，你好。"));
	...
	public void sendMessage(View view)
	{
		...
		new Thread()
		{
			public void run()
			{
				...
				{
					from = new ChatMessage(Type.INPUT, "我有些晕圈，一会儿和你聊。。。");
				}
